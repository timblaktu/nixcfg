# Generic Linux unified files configuration
# Universal Linux scripts only (excludes WSL-specific OneDrive tools)
...

{
  homeFiles = {
    ...
    # Universal Linux scripts only (9 total, excludes WSL-specific OneDrive tools)
    scripts = {

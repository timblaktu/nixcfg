...
**NEXT ACTIONABLE = P11 (PENDING). Do P11.** P1-P9 done; P10 stays IN_PROGRESS but its ONLY remaining step
(the public merge) is now GATED on P11 — do NOT attempt the merge until P11 is COMPLETE. A `/next-task`
that finds P10 IN_PROGRESS first should treat it as BLOCKED-BY-DEP on P11 and move to P11.

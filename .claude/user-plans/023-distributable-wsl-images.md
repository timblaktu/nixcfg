...
| Task 1 | `TASK:PENDING` | Create wsl-enterprise module (NixOS + HM) |
| Task 2 | `TASK:PENDING` | Create wsl-tiger-team module (NixOS + HM) |
| Task 3 | `TASK:PENDING` | Create nixos-wsl-tiger-team host + registration |
| Task 4 | `TASK:PENDING` | Refactor pa161878-nixos to use new layers |
| Task 5 | `TASK:PENDING` | Build tarball + validate + document |

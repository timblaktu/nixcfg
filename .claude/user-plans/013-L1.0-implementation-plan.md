...
**Status**: READY FOR EXECUTION - Skill v2.2.0 complete (Plan 039 done 2026-06-07). Use skill + example .rsc to deploy.
**Task**: L1.0 - Mikrotik network setup (using skill)

**Quick Start** (2026-06-07):
- Skill: `modules/programs/claude-code/_hm/skills/mikrotik-management/SKILL.md`
- Example config: `modules/programs/claude-code/_hm/skills/mikrotik-management/examples/L1.0-attic-network.rsc`
- Test cases: `modules/programs/claude-code/_hm/skills/mikrotik-management/test-cases.md`
- Helper scripts: `commands/mikrotik-status.sh`, `commands/mikrotik-backup.sh`
- Connect: `ssh admin@192.168.88.1` (ethernet direct, your IP must be 192.168.88.x/24)

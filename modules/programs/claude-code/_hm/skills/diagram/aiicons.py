...
"""
# Vendored as-is from Agents365-ai/drawio-skill (MIT) — scripts/aiicons.py.
# Icon names in data/lobe-icons.json come from lobehub/lobe-icons (MIT); logos
# are referenced from CDNs at render time (use --embed to inline them).
import argparse
import base64
import json
import os

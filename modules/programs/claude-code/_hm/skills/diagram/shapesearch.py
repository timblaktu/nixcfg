...
"""
# Vendored as-is from Agents365-ai/drawio-skill (MIT) — scripts/shapesearch.py.
# Bundled index data/shape-index.json.gz is upstream draw.io shape data
# (Apache-2.0); see data/SHAPE-INDEX-NOTICE.md.
import argparse
import gzip
import json
import os
